...
class CartCell: UITableViewCell {
    ...
    fileprivate func addHeading() {
        ...
        productName.widthAnchor.constraint(lessThanOrEqualTo: contentView.widthAnchor, multiplier: 0.35).isActive = true
    }
    ...
    fileprivate func addSubtext() {
        ...
        .addLeftAnchor(equal: productImageView.rightAnchor,constant: 20)
        subtitleName.widthAnchor.constraint(lessThanOrEqualTo: contentView.widthAnchor, multiplier: 0.45).isActive = true
